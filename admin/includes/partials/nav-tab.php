<div class="container">
    <!-- <div id="toast-success"><div id="img" class="toast-icon">Icon</div><div id="desc" class="toast-description">Settings Saved</div></div> -->
    ...
    <ul class="sm_tabs">
        <li class="sm_tabs-link current" data-tab="tab-general">
            ...
            <?php esc_html_e('General', 'site-mode'); ?>
        </li>
        <li class="sm_tabs-link" data-tab="tab-content">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M20 3H4c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM4 19V5h7v14H4zm9 0V5h7l.001 14H13z"></path><path d="M15 7h3v2h-3zm0 4h3v2h-3z"></path></svg>
            <?php esc_html_e('Content', 'site-mode'); ?>
        </li>
        <li class="sm_tabs-link" data-tab="tab-social">
            ...
            <?php esc_html_e('Social', 'site-mode'); ?>
        </li>
        <li class="sm_tabs-link" data-tab="tab-design">
            ...
            <?php esc_html_e('Design', 'site-mode'); ?>
        </li>
        <li class="sm_tabs-link" data-tab="tab-seo">
            ...
            <?php esc_html_e('SEO', 'site-mode'); ?>
        </li>
        <li class="sm_tabs-link" data-tab="tab-advanced">
            ...
            <?php esc_html_e('Advanced', 'site-mode'); ?>
        </li>
        <li class="sm_tabs-link" data-tab="tab-import-export">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="m5.005 15.995 4-4-4-4v3h-3v2h3zm14-5v-3l-4 4 4 4v-3h3v-2h-2.072zm-8 7h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2z"></path></svg>
            <?php esc_html_e('Import/Export', 'site-mode'); ?>
        </li>

    </ul>

    <div id="tab-general" class="tab-content current">
        <?php require_once plugin_dir_path( __FILE__ ) . "general-setting-page.php"; ?>
    </div>
    <div id="tab-content" class="tab-content">
        <?php require_once plugin_dir_path( __FILE__ ) . "content-setting-page.php"; ?>
    </div>
    <div id="tab-social" class="tab-content">
        <?php require_once plugin_dir_path( __FILE__ ) . "social-setting-page.php"; ?>
    </div>
    ...
    <div id="tab-import-export" class="tab-content">
        <?php require_once plugin_dir_path( __FILE__ ) . "export-import-setting-page.php"; ?>
    </div>
