<div class="wrap">
    ...
    <form id="rex-seo" method="post" action="<?php echo esc_html(admin_url('admin-post.php')); ?>" >
       <?php
       ...
       ?>
        ...
        <div>
            <?php if ($favicon_url) : ?>
                ...
                <input type="hidden" name="soe-meta-favicon-setting" value="<?php esc_attr_e($meta_favicon,'rex-maintenance-mode'); ?>">
            <?php else : ?>
        ...
        <div>
            <?php if ($image_url) : ?>
                ...
                <input type="hidden" name="soe-meta-image-setting" value="<?php esc_attr_e($meta_image,'rex-maintenance-mode'); ?>">
            <?php else : ?>
