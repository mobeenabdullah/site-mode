        ...
        <div class="section__wrapper-content section_theme">
            ...
            <form id="site-mode-design" method="post" action="<?php echo esc_html(admin_url('admin-post.php')); ?>">
                ...
                <div class="template__wrapper">
                    <a href="<?php echo esc_url(home_url( '?site_mode_preview=true')); ?>" class="preview-btn" target="_blank"><?php _e('Preview Active Theme','site-mode');?></a>
                    <div class="template_options">            
                        <div class="template_thumb <?php echo ($enable_template== '1') ? 'activated_template' : '' ?>">
                            ...
                            <div class="template_actions">
                                ...
                                <a href="<?php echo esc_url(home_url( "?site_mode_preview=true&template=foodTemplate")); ?>" class="preview-btn" target="_blank">Preview</a>
                        ...
                        <div class="template_thumb <?php echo ($enable_template == '2') ? 'activated_template' : '' ?>">
                            ...
                            <div class="template_actions">
                                ...
                                <a href="<?php echo esc_url(home_url( "?site_mode_preview=true&template=constructionTemplate")); ?>" class="preview-btn" target="_blank"><?php _e('Preview','site-mode');?></a>
                                <label class="um_toggle">
                        ...
                        <div class="template_thumb <?php echo ($enable_template == '3') ? 'activated_template' : '' ?>">
                            ...
                            <div class="template_actions">
                                ...
                                <a href="<?php echo esc_url(home_url( "?site_mode_preview=true&template=fashionTemplate")); ?>" class="preview-btn" target="_blank"><?php _e('Preview','site-mode');?></a>
                                <label class="um_toggle">
                        ...
                        <div class="template_thumb <?php echo ($enable_template == '4') ? 'activated_template' : '' ?>">
                            ...
                            <div class="template_actions">
                                ...
                                <a href="<?php echo esc_url(home_url( "?site_mode_preview=true&template=travelTemplate")); ?>" class="preview-btn" target="_blank"><?php _e('Preview','site-mode');?></a>
                                <label class="um_toggle">
