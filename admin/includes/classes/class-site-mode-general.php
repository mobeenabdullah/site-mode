...
//        }
    ...
    public function load_templates()
    {
        ...
        if ($this->enable_template == '1' || isset($_GET['template']) == 'foodTemplate') {
            require_once plugin_dir_path(dirname(__DIR__)) . '../public/templates/template-one.php';
            exit;
        } elseif ($this->enable_template == '2' || isset($_GET['template']) == 'constructionTemplate') {
            require_once plugin_dir_path(dirname(__DIR__)) . '../public/templates/template-two.php';
            exit;
        } elseif ($this->enable_template == '3' || isset($_GET['template']) == 'fashionTemplate') {
            require_once plugin_dir_path(dirname(__DIR__)) . '../public/templates/template-three.php';
            exit;
        } elseif ($this->enable_template == '4' || isset($_GET['template']) == 'travelTemplate') {
