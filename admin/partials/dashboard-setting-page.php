                                    ...
                                    <div class="sm_select_page-btn">
                                        <?php
                                            if(isset($design_settings['page_setup']) && isset($design_settings['page_setup']['coming_soon_page_id']) && !empty($design_settings['page_setup']['coming_soon_page_id'])) {
                                                ?>
                                                    <a href="<?php echo esc_url(get_edit_post_link(intval($design_settings['page_setup']['coming_soon_page_id']))); ?>" target="_blank" class="sm__btn block_btn secondary_btn">Customize</a>
                            ...
                            <div class="sm__card">
                                ...
                                <div class="sm_select_page-btn">
                                    ...
                                    if(isset($design_settings['page_setup']) && isset($design_settings['page_setup']['maintenance_page_id']) && !empty($design_settings['page_setup']['maintenance_page_id'])) {
                                        ?>
                                        <a href="<?php echo esc_url(get_edit_post_link(intval($design_settings['page_setup']['maintenance_page_id']))); ?>" target="_blank" class="sm__btn block_btn secondary_btn">Customize</a>
        ...
        <div class="sitemode__dashboard-cards">
            ...
            $dashboard_cards = [
                ...
                [
                    ...
                    'icon'  => '<svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 8h2v5c0 2.206 1.794 4 4 4h2v5h2v-5h2c2.206 0 4-1.794 4-4V8h2V6H3v2Zm4 0h10v5c0 1.103-.897 2-2 2H9c-1.103 0-2-.897-2-2V8Zm0-6h2v3H7V2Zm8 0h2v3h-2V2Z" fill="#FE4773"/></svg>',
                    'link'  => '/',
                ...
                [
                    ...
                    'icon'  => '<svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 6h2v2H4V6Zm0 5h2v2H4v-2Zm0 5h2v2H4v-2Zm16-8V6H8.023v2H20ZM8 11h12v2H8v-2Zm0 5h12v2H8v-2Z" fill="#FE4773"/></svg>',
                    'link'  => '/',
                ...
                [
                    ...
                    'icon'  => '<svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 6a3.939 3.939 0 0 0-3.934 3.934h2C10.066 8.867 10.934 8 12 8c1.066 0 1.934.867 1.934 1.934 0 .598-.481 1.032-1.216 1.626-.24.188-.47.388-.691.599-.998.997-1.027 2.056-1.027 2.174V15h2l-.001-.633c0-.016.033-.386.44-.793.15-.15.34-.3.536-.458.779-.631 1.958-1.584 1.958-3.182A3.937 3.937 0 0 0 12 6Zm-1 10h2v2h-2v-2Z" fill="#FE4773"/><path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2Zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8Z" fill="#FE4773"/></svg>',
