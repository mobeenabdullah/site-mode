    ...
    <div id="toast-success">
        <div class="toast-success-msg">
            ...
            <div id="desc" class="toast-description">
                <span><?php _e('Settings Saved','site-mode')?></span>
            </div>
        </div>
    </div>
    <div id="toast-error">
        <div class="toast-error-msg">
            ...
            <div id="desc" class="toast-description">
                <span><?php _e('Settings Not Saved','site-mode')?></span>
            </div>
        </div>
    </div>
    ...
    <ul class="sm_tabs">
        <?php
            $site_mode_tabs = [
	            ...
	            [
		            'title'=> 'Content',
		            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M20 3H4c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM4 19V5h7v14H4zm9 0V5h7l.001 14H13z"></path><path d="M15 7h3v2h-3zm0 4h3v2h-3z"></path></svg>'
	            ],
                [
                    'title'=> 'Social',
	            ...
	            [
		            'title'=> 'SEO',
		            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M3 5v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2H5c-1.103 0-2 .897-2 2zm16.001 14H5V5h14l.001 14z"></path><path d="M11 7h2v10h-2zm4 3h2v7h-2zm-8 2h2v5H7z"></path></svg>'
	            ],
	            [
		            'title'=> 'Advanced',
	            ...
	            [
		            'title'=> 'Import',
		            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="m5.005 15.995 4-4-4-4v3h-3v2h3zm14-5v-3l-4 4 4 4v-3h3v-2h-2.072zm-8 7h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2z"></path></svg>'
	            ],
            ];
            ...
            foreach ($site_mode_tabs as $tab) :
                ...
                echo '<li class="' . esc_attr($tab_class) . '" data-tab="' . esc_attr($tab_data) . '">' . $tab['icon'] . __($tab['title'], 'site-mode') . '</li>';
            endforeach; ?>
    </ul>
