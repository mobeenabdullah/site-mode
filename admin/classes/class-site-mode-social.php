...
class Site_Mode_Social extends Settings {
    ...
    public function ajax_site_mode_social() {
        ...
        $data = [
            'show_social'       => isset($_POST['show-social-icons-setting']) ? sanitize_text_field($_POST['show-social-icons-setting']) : '',
            'social_fb'         => [
	            'content'   =>     isset($_POST['content-social-fb-setting']) ? sanitize_url($_POST['content-social-fb-setting']) : '',
	...
	public function sort_social_content () {
		$social_media = [
			[
				...
				'value' => !empty($this->facebook['content']) ?: '',
				'order_key' => 'fb_order',
				'order_value' => !empty($this->facebook['order']) ?: '',
			...
			[
				...
				'value' => !empty($this->twitter['content']) ?: '',
				'order_key' => 'tw_order',
				'order_value' => !empty($this->twitter['order']) ?: '',
			...
			[
				...
				'value' => !empty($this->linkedin['content']) ?: '',
				'order_key' => 'linkedin-order',
				'order_value' => !empty($this->linkedin['order']) ?: '',
			...
			[
				...
				'value' => !empty($this->youtube['content']) ?: '',
				'order_key' => 'youtube-order',
				'order_value' => !empty($this->youtube['order']) ?: '',
			...
			[
				...
				'value' => !empty($this->instagram['content']) ?: '',
				'order_key' => 'instagram-order',
				'order_value' => !empty($this->instagram['order']) ?: '',
			...
			[
				...
				'value' => !empty($this->pinterest['content']) ?: '',
				'order_key' => 'pinterest-order',
				'order_value' => !empty($this->pinterest['order']) ?: '',
			...
			[
				...
				'value' => !empty($this->quora['content']) ?: '',
				'order_key' => 'quora-order',
				'order_value' => !empty($this->quora['order']) ?: '',
			...
			[
				...
				'value' => !empty($this->behance['content']) ?: '',
				'order_key' => 'behance-order',
				'order_value' => !empty($this->behance['order']) ?: '',
