...
const exportExcel = document.querySelector("#exportToExcel");
...
exportExcel.addEventListener("click", function () {
  tableToExcel('myTable', 'subscribe_table', 'subscribe_table.xls')
});

// tableToExcel('myTable', 'subscribe_table', 'test.xls');