...
public function rex_maintenance_content_social_fb_checkbox_cb() { ?>
    <div class="um_checkbox_wrapper">
    ...
    public function rex_maintenance_content_social_linkedin_checkbox_cb() { ?>
        <div class="um_checkbox_wrapper">
    ...
    public function rex_maintenance_content_social_twitter_checkbox_cb() { ?>
        <div class="um_checkbox_wrapper">
