...
function Edit(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", null, `
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Logged in behaviour', 'site-mode'),
    value: loggedInBehaviour,
    onChange: value => setAttributes({
      loggedInBehaviour: value
    }),
    options: [{
      value: 'hide',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Display nothing', 'site-mode')
    }, {
      value: 'user',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Show "Logged in as USER. Log Out"', 'site-mode')
    }, {
      value: 'logout',
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Just the log out link', 'site-mode')
    }, {
      value: 'login',
    ...
    type: "text",
    className: "input",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Default username', 'site-mode'),
    ...
    tagName: "label",
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Remember Me', 'site-mode'),
    keepPlaceholderOnFocus: "true",
    onChange: value => setAttributes({
    ...
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Log In', 'site-mode'),
    keepPlaceholderOnFocus: "true",
    onChange: value => setAttributes({
      labelSubmit: value
    }),
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('site-mode/login-form', {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunklogin_form_block"] = self["webpackChunklogin_form_block"] || [];
